          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                ...
                <p><?php echo getField('sname').", ".getField('fname');?><small>Examination Officer</small></p>
              </li>
              <!-- Menu Body -->
              ...
              <li class="user-footer">
                <div class="pull-left">
                  <a href="examOfficerProfile.php?user=examination_officer" class="btn btn-default btn-flat">Profile</a>
                </div>
