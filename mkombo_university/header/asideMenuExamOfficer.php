        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            ...
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span class="hidden-xs">Simon Kijo</span>
            </a>
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="active treeview">
          ...
          <ul class="treeview-menu">
            <li class="active">
				...
				<ul class="treeview-menu">
					<li class="active"><a href="#"><i class="fa fa-circle-o"></i> <span>Computer Eng</span> </a></li>
		...
		<li class="treeview">
          ...
          <ul class="treeview-menu">
			<li><a href="#"><i class="fa fa-book"></i> <span>Computer Eng</span> </a></li>
		...
		<li><a href="#"><i class="fa fa-user"></i> <span>Profile Settings</span></a></li>
      </ul>
      <!-- /.sidebar-menu -->
    </section>
    <!-- /.sidebar -->
