          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                ...
                <p><?php echo getField('sname').", ".getField('fname');?><small>Academic Officer</small></p>
              </li>
              <!-- Menu Body -->
              ...
              <li class="user-footer">
                <div class="pull-left">
                  <a href="academicProfile.php?user=academic_officer" class="btn btn-default btn-flat">Profile</a>
                </div>
