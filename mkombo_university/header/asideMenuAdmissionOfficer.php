          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                ...
                <p><?php firstCapitalLetter(getField('sname')); echo ', '; firstCapitalLetter(getField('fname'));?><small>Admission Officer</small></p>
              </li>
              <!-- Menu Body -->
              ...
              <li class="user-footer">
                <div class="pull-left">
                  <a href="admissionProfile.php?user=admission_officer" class="btn btn-default btn-flat">Profile</a>
                </div>
