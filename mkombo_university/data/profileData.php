<?php 
	if($_SERVER['REQUEST_METHOD'] == 'POST'){
		...
		if(isset($_POST['sv_pinfo'])){
			...
			$query = "UPDATE `mkombo_university`.`student` SET `email_address`='".$email."', `phone_no`='".$phone."', `marital_status`='".$marital."', `home_place`='".$home."', `password`='".$hash_pass."'";
		...
		if(isset($_POST['sv_binfo'])){
			...
			$queryb = "UPDATE `mkombo_university`.`bank_account` SET `bank_name`='".$bname."', `bank_branch`='".$bbranch."', `account_no`='".$accountno."'";
		...
		if(isset($_POST['sv_sponsor'])){
			...
			$querys = "UPDATE `mkombo_university`.`sponsor` SET `sponsor_name`='".$sname."', `sponsor_phone`='".$sphone."', `sponsor_email`='".$semail."'";
		...
		if(isset($_POST['sv_ttmaster'])){
			...
			$querytt = "UPDATE `mkombo_university`.`time_table_master` SET `email_address`='".$temail."', `phone_no`='".$tphone."', `username`='".$tusername."', `password`='".$hash_tpass."'";
		...
		if(isset($_POST['sv_examMaster'])){
			...
			$queryeo = "UPDATE `mkombo_university`.`examination_officer` SET `email_address`='".$eemail."', `phone_no`='".$ephone."', `username`='".$eusername."', `password`='".$hash_epass."'";
		...
		if(isset($_POST['sv_lec'])){
			...
			$querylec = "UPDATE `mkombo_university`.`lecturer` SET `email_address`='".$lemail."', `phone_no`='".$lphone."', `username`='".$lusername."', `password`='".$hash_lpass."'";
		...
		if(isset($_POST['sv_adm'])){
			...
			$queryadm = "UPDATE `mkombo_university`.`admission_officer` SET `email_address`='".$aemail."', `phone_no`='".$aphone."', `username`='".$ausername."', `password`='".$hash_apass."'";
