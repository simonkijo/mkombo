      ...
      <ul class="sidebar-menu">
		...
		<li class="active treeview">
			...
			<ul class="treeview-menu">
				...
				<li class="active"><a href="adminStudentDiploma.php"><i class="fa fa-file-o"></i> <span>Ordinary Diploma</span></a></li>
			</ul>
		</li>
							...
							<form method="post" enctype="multipart/form-data">
								...
								<div class="row">
									...
									<div class="col-md-3">
										<div class="form-group">
											<label></label><br>
											<button type="submit" name="sv_stDiploma" class="btn btn-primary">Save</button>
										</div>
									</div>
								</div>
							</form>
